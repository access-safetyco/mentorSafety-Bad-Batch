...
class My_Payment_Methods extends Framework\SV_WC_Payment_Gateway_My_Payment_Methods {
	...
	public function maybe_enqueue_styles_scripts() {
		...
		if ( $this->has_tokens ) {
			...
			wp_enqueue_script( 'wc-authorize-net-my-payment-methods', $this->get_plugin()->get_plugin_url() . '/assets/js/frontend/wc-authorize-net-my-payment-methods.min.js', [ 'sv-wc-payment-gateway-my-payment-methods-v5_12_6' ], $this->get_plugin()->get_version() );
		}
	}
