...
class Frontend extends Framework\SV_WC_Payment_Gateway_Apple_Pay_Frontend {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'wc-authorize-net-apple-pay', $this->get_plugin()->get_plugin_url() . '/assets/js/frontend/wc-authorize-net-apple-pay.min.js', [ 'sv-wc-apple-pay-v5_12_6' ], $this->get_plugin()->get_version() );
	}
