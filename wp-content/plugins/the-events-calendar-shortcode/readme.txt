...
**Get your events displayed in a customizable list wherever you need them, with The Events Calendar Shortcode and Block!** This plugin fully integrates with The Events Calendar Plugin (free version) by StellarWP, formerly Modern Tribe.

This plugin adds a shortcode, a WordPress block, and now an **Elementor** widget for use with The Events Calendar WordPress Plugin.
